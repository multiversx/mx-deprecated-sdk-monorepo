...
describe("test arguments", () => {
    it("should create arguments", async () => {
        ...
        assert.equal(Argument.fromBigInt(new BigNumber("1000000000000000000000000000000000")).valueOf(), "314dc6448d9338c15b0a00000000");
        assert.equal(Argument.fromTypedValue(new BigUIntValue(new BigNumber(0xabba))).valueOf(), "abba");
