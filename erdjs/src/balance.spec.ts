...
describe("test balance", () => {
    ...
    it("should format as currency", () => {
        assert.equal(Balance.eGLD(0.1).toCurrencyString(), ".100000000000000000 eGLD");
        ...
        assert.equal(Balance.eGLD("0.123456789").toCurrencyString(), ".123456789000000000 eGLD");
        assert.equal(Balance.eGLD("0.123456789123456789777777888888").toCurrencyString(), ".123456789123456789 eGLD");
    });
});
